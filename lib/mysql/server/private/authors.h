...
struct show_table_authors_st show_table_authors[]= {
  ...
  { "Jan Lindstr?m", "Yl?mylly, Finland", "Working on InnoDB"},
  ...
  { "Mikael Ronstr?m", "Stockholm, Sweden",
    "NDB Cluster, Partitioning, online alter table" },
  { "Ingo Str��wing", "Berlin, Germany",
    "Bug fixing in MyISAM, Merge tables etc" },
  {"Marko M?kel?", "Helsinki, Finland", "InnoDB core developer"},
  ...
  { "Magnus Svensson", "?regrund, Sweden",
